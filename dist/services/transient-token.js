...
export const CreateTransientTokenService = (secret, defaultTransientTTL) => ({
    /**
     ...
     * ```
     */
    generate: (payload, expiresIn = defaultTransientTTL) => {
        return jwt.sign(payload, secret, { expiresIn: expiresIn });
    }
});
export const tokenService = CreateTransientTokenService(process.env.CLIENT_AUTH_SECRET || String(Math.random()), process.env.DEFAULT_CLIENT_AUTH_TTL || '10m');
//# sourceMappingURL=transient-token.js.map