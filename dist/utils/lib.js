 ...
 *
 * Extracts the HTTP method, resource, and action from the request path,
 * and safely parses the request body.
 *
 * @param reqOrEvent - The Express Request object or API Gateway Proxy Event V2
 * @returns A RequestEvent object containing:
 *   - httpContext: The original request/event object
