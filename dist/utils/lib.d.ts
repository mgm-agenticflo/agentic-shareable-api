...
export declare function isTrue(mystery: string | undefined): boolean;
/**
 ...
 * ```
 */
export declare function safeJson<T = Record<string, unknown>>(body: string | null | undefined, isBase64Encoded?: boolean): T;
/**
 ...
 * ```
 */
export declare function hasKey(mystery: unknown, key: string): mystery is Record<string, unknown>;
/**
 ...
 */
export declare function parseHttpEvent(event: APIGatewayProxyEventV2): RequestEvent;
